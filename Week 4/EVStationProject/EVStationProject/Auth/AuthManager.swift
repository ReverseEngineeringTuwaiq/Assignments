...
class AuthManager {
    ...
    let client = SupabaseClient(supabaseURL: URL(string: "https://wtduwwxsovwsgwynjbmb.supabase.co")!, supabaseKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind0ZHV3d3hzb3Z3c2d3eW5qYm1iIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDc1ODgzODAsImV4cCI6MjAyMzE2NDM4MH0.rjAgVJqvmq8cmn7nDwv7j390ItyWGiRQ45C2_i2YVpE")
